...
export const ThemeSwitchWrapper = styled(FormGroup)`
	display: flex;
	gap: 15px;
`;
...
// 	active: boolean;
// }
// export const ThemeSwitchButton = styled.button<IButtonProps>`
// 	background: none;
// 	border: none;
// 	padding: 0;
// 	font: inherit;
...
// 	width: 30px;
// `;
export const ThemeSwitchThemeSwitch = styled(Switch)(({ theme }) => ({
	width: 62,
	height: 34,
	padding: 7,
